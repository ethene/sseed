...
class TestValidatePhase2(unittest.TestCase):
    ...
    def test_enhanced_entropy_validation(self):
        ...
        with patch(
            ...
            call_args = mock_analyze.call_args
            self.assertEqual(
                call_args[1]["strict_mode"], True
            )  # Entropy mode uses strict
            ...
            entropy_check = self.command.validation_results["checks"][
                "entropy_analysis"
            ]
        ...
        with (
            ...
            mock_analyze.return_value = {
                ...
                "checks": {
                    "format_validation": {
                        "status": "pass",
                        "message": "Valid 12-word format",
                    },
                    "language_detection": {
                        "status": "pass",
                        "message": "English (confidence: 0.98)",
                    },
                    "checksum_validation": {
                        "status": "pass",
                    ...
                    "weak_patterns": {
                        "status": "pass",
                        "message": "No weak patterns detected",
                    },
                    "entropy_analysis": {
                        "status": "pass",
                        "message": "Excellent entropy (128 bits)",
                    },
                },
            }
