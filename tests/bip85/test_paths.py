...
class TestValidateBip85Parameters:
    ...
    def test_hd_seed_validation(self):
        ...
        with pytest.raises(Bip85ValidationError, match="HD-Seed WIF length must be 512"):
    ...
    def test_password_validation(self):
        ...
        # Invalid ranges
        with pytest.raises(Bip85ValidationError, match="Password length must be 10-128"):
