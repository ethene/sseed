...
def derive_bip85_entropy(
    ...
    1. Create BIP32 master key from master seed
    ...
    try:
        logger.info(
            ...
            application, length, index, output_bytes
        )
        ...
        # Step 1: Create BIP32 master key
        master_key = create_bip32_master_key(master_seed)
        ...
        child_key = master_key.ChildKey(BIP85_PURPOSE | 0x80000000)  # Purpose (hardened)
        child_key = child_key.ChildKey(application | 0x80000000)     # Application (hardened) 
        ...
        for var_name, var_value in [
            ...
            if var_value is not None:
                try:
                    ...
                    logger.warning(
                        "Failed to securely clean up %s: %s", 
                        var_name, cleanup_error
                    )
